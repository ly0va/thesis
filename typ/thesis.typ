...
Aave @aave -- це децентралізований протокол позик, розгорнутий на блокчейні Ethereum. Aave є скороченням від слова "привид" на фінській мові, що символізує прозорість в криптоекосистемі.
...
\
== Тестування та розрахунок потенційних прибутків
\

Проаналізувавши події (_events_) `Deposit` та `Withdrawal` на смарт-контрактах Tornado Cash, а також
події `FlashLoan` на смарт-контракті Aave за допомогою Etherscan API, можемо просимулювати
роботу протоколу з наведеними вище інтеграцієми та розрахувати потенційний прибуток від них.
